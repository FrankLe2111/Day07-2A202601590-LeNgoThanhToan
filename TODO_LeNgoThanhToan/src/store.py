...
class EmbeddingStore:
    ...
    def __init__(
        ...
        try:
            ...
            # Keep the deterministic in-memory implementation as the default.
            # Chroma is optional and should not make tests depend on a service.
            self._use_chroma = False
        except Exception:
            self._use_chroma = False
            self._collection = None
            ...
            scored.append(
                {
                    ...
                    "score": _dot_product(query_embedding, record["embedding"]),
                }
            )
