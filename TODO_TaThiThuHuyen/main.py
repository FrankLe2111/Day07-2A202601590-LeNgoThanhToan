...
# Thư mục dữ liệu mặc định = corpus chính sách Tiki đã thu thập của nhóm.
...
def run_manual_demo(question: str | None = None, data_dir: str | None = None) -> int:
    ...
    store = build_knowledge_base(data_dir, embedding_fn=embedder, chunking_strategy=ChunkingStrategyComparator())
